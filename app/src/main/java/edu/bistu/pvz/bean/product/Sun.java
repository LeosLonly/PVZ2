...
import edu.bistu.pvz.bean.base.Product;
...
public class Sun extends Product {
	...
	public void addSun() {
		...
		int d = (int) CGPointUtil.distance(
				CGPoint.ccp(20,CCDirector.sharedDirector().getWinSize().getHeight() - 20),
				CGPoint.ccp(getPosition().x,getPosition().y));
		float t = (float)d / 200;
